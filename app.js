...
const mode = document.getElementById('list');
const option = document.querySelectorAll('option');
const restart = document.getElementById('reset')
pen.fillStyle = 'blue';

let time;
const cs = 37;     //cell size
const w = 700;
const h = 555;
let food = null;
let score = 0;
...
function draw(){
    ...
    pen2.font = '30px Monaco,Monospace';
    pen2.fillText(`Score : ${score}`,40,50);
    pen.fillStyle='green';
...
const id =setInterval(gameloop,time);